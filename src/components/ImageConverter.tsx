    ...
    <div className="space-y-6">
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          role="img"
          aria-label="Upload image for format conversion"
        >
          <path
            strokeLinecap="round"
...
function StatusIcon({ status }: { status: ConvertedFile["status"] }) {
  ...
  if (status === "done")
    return (
      <svg className="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20" role="img" aria-label="Conversion complete">
        <path
          fillRule="evenodd"
  ...
  return (
    <svg className="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20" role="img" aria-label="Conversion failed">
      <path
        fillRule="evenodd"
