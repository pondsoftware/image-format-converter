        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "PNG to ICO Converter", "item": "https://imageconverters.net/png-to-ico" }
            ]
          })
        }}
      />
        ...
        <div className="mt-12">
          <section>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              ...
              <Link href="/ico-to-png" className="text-sm text-blue-600 hover:text-blue-800 hover:underline bg-blue-50 rounded-lg px-3 py-2 text-center transition">
                ICO to PNG
              </Link>
