        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "AVIF to PNG Converter", "item": "https://imageconverters.net/avif-to-png" }
            ]
          })
        }}
      />
        ...
        <div className="mt-12">
          <section>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              ...
              <Link href="/avif-to-webp" className="text-sm text-blue-600 hover:text-blue-800 hover:underline bg-blue-50 rounded-lg px-3 py-2 text-center transition">
                AVIF to WebP
              </Link>
