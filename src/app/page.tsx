...
const converterPages = [
  ...
  { href: "/gif-to-jpg", label: "GIF to JPG" },
  { href: "/tiff-to-jpg", label: "TIFF to JPG" },
  { href: "/tiff-to-png", label: "TIFF to PNG" },
  { href: "/bmp-to-jpg", label: "BMP to JPG" },
  { href: "/bmp-to-png", label: "BMP to PNG" },
  { href: "/ico-to-png", label: "ICO to PNG" },
